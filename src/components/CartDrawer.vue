...
// 👇 FIX: Control de hidratación para SSR
...
<template>
  <!-- 👇 FIX: Solo renderiza en el cliente después del montaje -->
  <div v-if="isMounted">
    <!-- Backdrop -->
  ...
  <div v-else class="fixed top-0 right-0 h-full w-full max-w-sm z-50 hidden"></div>
</template>
